...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'kanban-card': '0 1px 3px hsl(var(--card-shadow))',
        'kanban-card-hover': '0 4px 12px hsl(var(--card-shadow))',
        'kanban-column': '0 2px 8px hsl(var(--card-shadow))',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
